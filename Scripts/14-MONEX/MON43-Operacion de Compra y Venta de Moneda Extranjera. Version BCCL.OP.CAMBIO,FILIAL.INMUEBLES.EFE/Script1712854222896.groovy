...
WebUI.click(findTestObject('Object Repository/15-MONEX/13-Vnta mon ext compra Inmueble/lnkEFECTIVO'))
...
WebUI.click(findTestObject('Object Repository/15-MONEX/12-Compra-Venta/rbV-ViegenteEFECTIVO'))
