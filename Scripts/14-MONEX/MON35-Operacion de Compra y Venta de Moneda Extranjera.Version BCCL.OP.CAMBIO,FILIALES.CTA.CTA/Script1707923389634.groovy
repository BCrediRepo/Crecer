...
WebUI.setText(findTestObject('Object Repository/15-MONEX/Ingreso de parametros generales de la operacion de Moneda Extranjera/txtIngresoFondos'), 'CUENTA')

//Setear Egreso Fondos
WebUI.setText(findTestObject('Object Repository/15-MONEX/Ingreso de parametros generales de la operacion de Moneda Extranjera/txtEgresoFondos'), 'CUENTA')
...
WebUI.setText(findTestObject('Object Repository/15-MONEX/12-Compra-Venta/txtIDCuentaDebito'), '21190118359')
...
WebUI.setText(findTestObject('Object Repository/15-MONEX/12-Compra-Venta/txtIDCuentaCredito'), '11190118359')
