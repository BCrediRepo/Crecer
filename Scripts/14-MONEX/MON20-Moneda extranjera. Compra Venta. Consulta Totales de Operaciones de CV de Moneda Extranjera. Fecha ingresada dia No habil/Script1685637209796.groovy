...
WebUI.setText(findTestObject('15-MONEX/Consulta de Totales - Operatoria de Compra Venta/txtFechaBoleto'), '20220723')
...
assert label == 'Solo permite fecha del dia, habil anterior o posterior'
