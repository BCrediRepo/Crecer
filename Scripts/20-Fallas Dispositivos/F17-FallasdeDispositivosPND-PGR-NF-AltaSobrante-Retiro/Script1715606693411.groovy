...
//Ingresar "FUNDS.TRANSFER,SOBRANTE.DISPOSITIVO.PGR" en el buscador
WebUI.setText(findTestObject('02-Dashboard/txtDashboardBuscador'), 'FUNDS.TRANSFER,SOBRANTE.DISPOSITIVO.PGR')
...
//Setear trx1 en Sobrantes en Dispositivos MAP
