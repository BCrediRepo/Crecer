...
//Filtra por SBL.RETURN=0, SBL.STATUS=POSTED,SBL.COD-SUC: 063, SBL.SETTLEMENT= N
...
WebUI.setText(findTestObject('Object Repository/16-Movimientos Automaticos/BCCL.MOV.AUT.INP.DATA/inputSBL.SETTLEMENT'), 'N')
