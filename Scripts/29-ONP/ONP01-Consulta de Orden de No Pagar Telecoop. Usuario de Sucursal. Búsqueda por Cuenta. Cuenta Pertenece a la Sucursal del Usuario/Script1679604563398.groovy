...
WebUI.click(findTestObject('30-ONP/Consulta de ONP Telecoop/lnkNuevaSeleccion'))

WebUI.click(findTestObject('30-ONP/Consulta de ONP Telecoop/lnkEjecutar'))

form = WebUI.waitForElementVisible(findTestObject('30-ONP/Consulta de ONP Telecoop/formConsulta'), 60)
