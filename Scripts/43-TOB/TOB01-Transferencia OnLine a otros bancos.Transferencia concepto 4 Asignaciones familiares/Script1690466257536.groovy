...
WebUI.setText(findTestObject('44-TOB/Movimiento de Fondos/txtConcepto'), '4')
...
assert ConceptoNoExistente.contains("TIPO.CONCEPTO 4 NO CORRESPONDE A LA TRANSACCION") == true
