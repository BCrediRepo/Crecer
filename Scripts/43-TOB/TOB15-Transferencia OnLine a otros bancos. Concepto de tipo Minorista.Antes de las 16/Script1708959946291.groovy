...
//Seteo de datos
WebUI.setText(findTestObject('44-TOB/Movimiento de Fondos/txtConcepto'), '7')
...
WebUI.click(findTestObject('Object Repository/44-TOB/Movimiento de Fondos/00-DrillDownMotivo/lblJudiciales'))
