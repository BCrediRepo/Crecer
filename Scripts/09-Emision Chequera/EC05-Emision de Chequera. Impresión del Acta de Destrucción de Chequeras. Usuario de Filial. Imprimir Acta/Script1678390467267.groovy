...
WebUI.waitForElementVisible(findTestObject('Object Repository/02-Dashboard/8-Emision Chequera/lnkModificaciondechequera'), 6)
WebUI.click(findTestObject('Object Repository/02-Dashboard/8-Emision Chequera/lnkModificaciondechequera'))
WebUI.waitForElementVisible(findTestObject('Object Repository/02-Dashboard/8-Emision Chequera/02-Modificacion de Chequera/lnkImpresionActadeDestruccion'), 6)
