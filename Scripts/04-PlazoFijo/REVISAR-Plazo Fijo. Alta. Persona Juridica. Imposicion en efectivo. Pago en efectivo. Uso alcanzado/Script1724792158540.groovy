...
//Elegir la opcion "EFECTIVO" del combobox de tipo de imposicion
WebUI.selectOptionByIndex(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/cbTipoImposicion'), 3)
...
assert usuarioAutoriza.contains('B.2055')
