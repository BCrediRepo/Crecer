...
//Seleccionar txt de "Nro cuenta de Imposicion"
WebUI.click(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/txtNroCuentaImposicion'))

//Seleccionar boton drop down de "Nro cuenta de Imposicion"
WebUI.click(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/btnDropdownNroCuentaImposicion'))

//Seleccionar Numero de cuenta
WebUI.click(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/lblNroCuentaImposicion'))
