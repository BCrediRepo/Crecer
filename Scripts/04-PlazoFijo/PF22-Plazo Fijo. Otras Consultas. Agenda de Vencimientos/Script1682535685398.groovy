...
WebUI.setText(findTestObject('02-Dashboard/txtDashboardBuscador'), 'ENQ BCCL.MM.ACTIVOS.FVENC.MM ')
...
WebUI.verifyElementVisible(findTestObject('05-PlazoFijo/Agenda de Vencimientos/formConsulta'))
