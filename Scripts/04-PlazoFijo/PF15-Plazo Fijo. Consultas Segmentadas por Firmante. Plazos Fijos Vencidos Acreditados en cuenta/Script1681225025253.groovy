...
WebUI.waitForElementVisible(findTestObject('05-PlazoFijo/Acreditados en Cuenta Segmentado/lnkVertitular'), 5)

WebUI.click(findTestObject('05-PlazoFijo/Acreditados en Cuenta Segmentado/lnkVertitular'))
