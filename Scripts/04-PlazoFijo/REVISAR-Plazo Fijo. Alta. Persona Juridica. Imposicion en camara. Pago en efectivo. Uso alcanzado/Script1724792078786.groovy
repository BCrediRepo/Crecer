...
//Cambiar a la ventana "Alta Plazo Fijo Persona Juridica"
...
//Maximizar Ventana
WebUI.maximizeWindow()
CustomKeywords.'pkgModules.kywSetDato.SeteoDato'('Id. Persona', '1002192774')
...
WebUI.click(findTestObject('Object Repository/05-PlazoFijo/Alta Plazo Fijo Persona Juridica/lblAltaPlazoFijo'))

//Setear Circular
WebUI.setText(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/txtCircular'), '44')
...
//Elegir la opcion "ALCANZADO" del combobox de uso
WebUI.selectOptionByIndex(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/cbUso'), 1)

//Elegir la opcion "CAMARA" del combobox de tipo de imposicion
WebUI.selectOptionByIndex(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/cbTipoImposicion'), 1)
...
//Elegir la opcion "EFECTIVO"
WebUI.selectOptionByIndex(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/cbTipoLiquidacion'), 4)
...
//Verificar "Usuario Autoriza"
WebUI.verifyElementVisible(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/lblUsuarioAutoriza'))

//Validar "Usuario Autoriza"
def usuarioAutoriza = WebUI.getText(findTestObject('Object Repository/05-PlazoFijo/PLAZO FIJO/lblUsuarioAutoriza'))
assert usuarioAutoriza.contains('B.4815')
