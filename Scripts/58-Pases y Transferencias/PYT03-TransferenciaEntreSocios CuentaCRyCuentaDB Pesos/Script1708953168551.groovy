...
//Setear ID Ordenante
WebUI.setText(findTestObject('Object Repository/12-Transferencias Internas/Movimiento de Fondos/txtIDOrdenante'), '1002143103')

//Maximizar Ventana
WebUI.maximizeWindow()

//Setear Nro. de Cuenta Debito
WebUI.setText(findTestObject('Object Repository/51-MAP/Movimiento de Fondos/txtNro. de Cuenta Debito'), '00740000115')
...
WebUI.setText(findTestObject('Object Repository/51-MAP/Movimiento de Fondos/txtNro. de Cuenta Credito'), '00740001323')

//Setear Importe
WebUI.setText(findTestObject('Object Repository/51-MAP/Movimiento de Fondos/txtImporte'), '100')
