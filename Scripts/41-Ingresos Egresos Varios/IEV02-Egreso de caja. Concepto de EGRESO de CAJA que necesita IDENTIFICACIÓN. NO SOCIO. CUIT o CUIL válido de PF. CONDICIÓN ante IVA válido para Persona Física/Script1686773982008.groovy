...
WebUI.selectOptionByIndex(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/cbxSocio'), 1)

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/txtCuitCuil'))

WebUI.setText(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/txtCuitCuil'), '20203798041')

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/btnDropDownCondicionIVA'))

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/lblConsumidorFinal'))
