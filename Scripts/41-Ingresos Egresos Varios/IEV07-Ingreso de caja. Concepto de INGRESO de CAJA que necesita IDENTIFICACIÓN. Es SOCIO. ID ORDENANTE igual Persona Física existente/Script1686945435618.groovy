...
def link = "Ingresos Varios de Caja"
...
WebUI.selectOptionByIndex(findTestObject('42-Ingresos Egresos Varios/TELLER-Ingresos/cbxSocio'), 2)

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Ingresos/txtIDOrdenante'))

WebUI.setText(findTestObject('42-Ingresos Egresos Varios/TELLER-Ingresos/txtIDOrdenante'), '1000873562')
