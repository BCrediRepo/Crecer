...
WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/lblARS'))

WebUI.setText(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/txtImporteARS'), '1000')

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/btnDropDownConcepto'))

WebUI.click(findTestObject('42-Ingresos Egresos Varios/TELLER-Egresos/lblPagoHonorarios'))
