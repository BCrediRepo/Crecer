...
def id = '1002132489' //caso con precondicion de persona con cuentas en diferentes sucursales
...
def link0 = "Cierre de Cuenta SIN Cancelacion de Saldo"
...
//Valido contenido de lnk cierre de saldo
WebUI.verifyElementVisible(findTestObject('Object Repository/25-Cierre de Cuenta/BCCL.AC.CIERRE.CTA.CON.SALDO/lnkCierreConSaldo'))
lnk = WebUI.getText(findTestObject('Object Repository/25-Cierre de Cuenta/BCCL.AC.CIERRE.CTA.CON.SALDO/lnkCierreConSaldo'))
assert lnk == "Cierre con Saldo"
