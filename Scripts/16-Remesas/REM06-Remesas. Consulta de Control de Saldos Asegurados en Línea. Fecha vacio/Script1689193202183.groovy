...
WebUI.setText(findTestObject('17-Remesas/BCCL.E.TT.TESORERIA.GENERAL/txtFecha'), '')
...
WebUI.verifyElementVisible(findTestObject('17-Remesas/BCCL.E.TT.TESORERIA.GENERAL/lblFechaVacio'))

label = WebUI.getText(findTestObject('17-Remesas/BCCL.E.TT.TESORERIA.GENERAL/lblFechaVacio'))

assert Mensaje == 'Mensaje de Error'

assert label == 'FECHA es de Ingreso Obligatorio' //Control de fin de script
