...
//Ingresar "TELLER,RECEPCION.REME.OBANCO.FILIAL I F3" en el buscador
WebUI.setText(findTestObject('02-Dashboard/txtDashboardBuscador'), 'TELLER,RECEPCION.REME.OBANCO.FILIAL I F3')
...
WebUI.setText(findTestObject('Object Repository/17-Remesas/03-TELLER/txtCantidadRecepMil'), '1')
