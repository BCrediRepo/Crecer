...
//Ingresar "TELLER,ENVIO.REMESAS.SIN.PEDIDO I F3" en el buscador
WebUI.setText(findTestObject('02-Dashboard/txtDashboardBuscador'), 'TELLER,ENVIO.REMESAS.SIN.PEDIDO I F3')
...
//Seleccionar "ARS"
WebUI.click(findTestObject('Object Repository/17-Remesas/03-TELLER/lblARSEnvio'))
...
WebUI.click(findTestObject('Object Repository/17-Remesas/03-TELLER/btnDropdownOrigenEnvio'))

//Seleccionar "TF"
WebUI.click(findTestObject('Object Repository/17-Remesas/03-TELLER/lblTFenvio'))
...
WebUI.setText(findTestObject('Object Repository/17-Remesas/03-TELLER/txtCantidadMilEnvio'), '1')
