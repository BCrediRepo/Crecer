...
//Seteo de Datos "Nro de Cuenta", tipo de comision no informado
...
//Assert	
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblAlertaMensajeComision'),6)

WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblAlertaMensajeComision'))

def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblAlertaMensajeComision'))

assert element.contains('TIPO.COMISION es de Ingreso Obligatorio') 
