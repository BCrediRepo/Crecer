...
//Seteo de Datos "Cuenta", "Sucursal"
...
def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/Comision Bonificaciones/lblCuenta1'))

assert element.contains('00010021329') == true
