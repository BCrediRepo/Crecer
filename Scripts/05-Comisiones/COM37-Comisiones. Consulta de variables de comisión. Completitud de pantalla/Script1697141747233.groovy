...
//click en boton Variables
WebUI.click(findTestObject('Object Repository/06-Comisiones/Tipos de Comision/btnVariables'))

// Captura el tiempo de inicio
long startTime = System.currentTimeMillis()

//Espera y Verifica que se muestren las columnas del registro
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/Variables-COMMISSION REPOSITORY/lblTipo Comision'),10)
WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/Variables-COMMISSION REPOSITORY/lblTipo Comision'))
...
def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/Variables-COMMISSION REPOSITORY/lblTipo Comision'))
assert element.contains('Tipo Comision')
