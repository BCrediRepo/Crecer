...
//click en boton tipos de comisiones
WebUI.click(findTestObject('Object Repository/06-Comisiones/Tipos de Comision/btnComisiones'))

// Captura el tiempo de inicio
long startTime = System.currentTimeMillis()

//Espera y Verifica que se muestren las columnas del registro
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/Comisiones/lblCodigoComision'),10)
WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/Comisiones/lblCodigoComision'))
...
def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/Comisiones/lblCodigoComision'))
assert element.contains('Codigo Comision')
