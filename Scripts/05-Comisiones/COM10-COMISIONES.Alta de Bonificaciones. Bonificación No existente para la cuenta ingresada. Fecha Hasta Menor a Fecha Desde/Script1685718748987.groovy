...
//Ingresa fecha hasta.
WebUI.setText(findTestObject('06-Comisiones/BCCL.E.CTA.CONS.BONIF/txtFechaVigenciaHasta'), '20220728')

//Acepta el registro
WebUI.click(findTestObject('06-Comisiones/BCCL.E.CTA.CONS.BONIF/btnAceptarRegistro'))

//Assert
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecHasDebeSer'), 6)

WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecHasDebeSer'))

def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecHasDebeSer'))

assert element.contains('FEC HAS DEBE SER MAYOR O IGUAL A FEC DES')

WebUI.click(findTestObject('06-Comisiones/BCCL.E.CTA.CONS.BONIF/lnkBonificacion-Consulta')) //Control de fin de script
