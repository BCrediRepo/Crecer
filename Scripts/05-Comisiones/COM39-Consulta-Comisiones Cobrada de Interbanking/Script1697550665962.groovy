...
//Espera y Verifica titulo de Consulta de Comisiones Interbaking
//WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.AC.COM.ITB/lblTituloConsultadeComisionesInterbaking'),5)
//WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.AC.COM.ITB/lblTituloConsultadeComisionesInterbaking'))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.AC.COM.ITB/lblFecha'),6)
WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.AC.COM.ITB/lblFecha'))
...
def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/BCCL.E.AC.COM.ITB/lblFecha'))
