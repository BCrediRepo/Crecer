...
//Assert
WebUI.waitForElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecDebeSerMayorOIgual'), 
    6)

WebUI.verifyElementVisible(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecDebeSerMayorOIgual'))

def element = WebUI.getText(findTestObject('Object Repository/06-Comisiones/BCCL.E.CTA.CONS.BONIF/lblFecDebeSerMayorOIgual'))
