...
WebUI.maximizeWindow()
WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkCargaDatosAbogado'), 6)
WebUI.click(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkCargaDatosAbogado'))
...
if (abogadoNombre.contains('1234'))
	WebUI.setText(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/txtNombreAbogado'), 'CRECERTEST')
		...
		WebUI.setText(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/txtNombreAbogado'), 'TEST1234')

WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/btnAceptarRegistro'), 6)
WebUI.click(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/btnAceptarRegistro'))

def regSinCambios = WebUI.getText(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lblRegSinCambios'))
if (regSinCambios.contains('El registro informado no presenta cambios')) {
	WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkBCCL.E.AC.CTAS.LEG'), 6)
	WebUI.click(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkBCCL.E.AC.CTAS.LEG'))
	WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkCargaDatosAbogado'), 6)
	WebUI.click(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lnkCargaDatosAbogado'))
	WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/txtNombreAbogado'), 6)
	WebUI.setText(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/txtNombreAbogado'), 'CRECERTEST')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lblTxnCompleta'), 6)
def element = WebUI.getText(findTestObject('Object Repository/28-Legales/02-BCCL.E.AC.CTAS.LEG/lblTxnCompleta'))
