...
CustomKeywords.'pkgModules.kywSetDato.SeteoDato'('Nro Documento', DNI)
WebUI.click(findTestObject('00-Utils/02-Filtros/lnkEjecutar'))
def titular = "O CONVERTINI LUCERO"
...
//CustomKeywords.'pkgModules.kywSetDato.SeteoDato'('Nro Documento', '3388401')
//
