...
def titular = "GEN AVE SA"
def encontrado = false
try {	
	while (!encontrado) {
		encontrado = validarElementoEnTabla(titular, 1, "BLOQUEO DEBITOS", 5)
	}
...
try {
	...
	WebUI.click(findTestObject('00-Utils/02-Filtros/lnkEjecutar'))
	encontrado = false
	def usercuenta = "00310099439"
	while (!encontrado) {
		encontrado = validarElementoEnTabla(usercuenta, 0, "BLOQUEO CREDITOS", 5)
	}
	String cuentita = GlobalVariable.vTxn
	assert cuentita.contains('0031')
	...
	assert cuentita.contains('0031')
	encontrado = false
	usercuenta1 = "00013020620"
	while (!encontrado) {
		encontrado = validarElementoEnTabla(usercuenta1, 0, "BLOQUEO DEBITOS", 5)
	}
	cuentita = GlobalVariable.vTxn
	assert cuentita.contains('0001')
}
//---------------------------------------------------------------------------------------------------------------------
