...
def validarElementoEnTabla(String variable, int postdList, String razon) {
...
CustomKeywords.'pkgModules.kywGeneric.Login'(findTestData('MainData/Users').getValue(1,69), findTestData('MainData/Users').getValue(2,69))
...
try {	
	while (!encontrado) {
		encontrado = validarElementoEnTabla(titular, 5, "BLOQUEO CREDITOS")
	}
