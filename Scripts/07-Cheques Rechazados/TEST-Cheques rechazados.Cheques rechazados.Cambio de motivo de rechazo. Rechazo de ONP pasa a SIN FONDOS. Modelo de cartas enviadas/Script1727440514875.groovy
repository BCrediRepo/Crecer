...
//Seteo info para modificar
//WebUI.delay(3)
//WebUI.click(findTestObject('Object Repository/08-Cheques Rechazados/txtCausa1prueba'))
//WebUI.waitForElementVisible(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtCausa1prueba'),6)
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/txtCausa1prueba'), '917')
//WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
WebUI.waitForElementVisible(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtIdSubCausa'),6)
WebUI.click(findTestObject('Object Repository/08-Cheques Rechazados/txtSubCausaPrueba'))
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtIdSubCausa'), '1')
 
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
WebUI.waitForElementVisible(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtMotivoRechazo'),6)
 
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtMotivoRechazo'), '10')
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
...
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtIdCausa'), '908')
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtIdSubCausa'), '24')
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
WebUI.setText(findTestObject('Object Repository/08-Cheques Rechazados/Cambio De Motivo De Rechazo/txtMotivoRechazo'), '08')
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnValidarRegistro'))
WebUI.click(findTestObject('Object Repository/00-Utils/06-ToolBar/btnAceptarRegistro'))
