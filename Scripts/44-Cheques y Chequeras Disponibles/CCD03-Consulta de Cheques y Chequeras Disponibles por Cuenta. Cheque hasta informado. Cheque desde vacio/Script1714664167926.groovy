...
WebUI.waitForElementVisible(findTestObject('Object Repository/45-Cheques y Chequeras Disponibles/BCCL.E.CONS.CHQ.CUENTA.FIL/lblMensajeError'), 5)
...
assert element.contains('DEBE INFORMARSE CHEQUE DESDE SI SE INGRESA CHEQUE HASTA')
