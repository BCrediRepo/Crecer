...
WebUI.waitForElementVisible(findTestObject('02-Dashboard/37-Cuentas/lnkConsultaDeCuentasPorCuenta'), 5)

WebUI.waitForElementVisible(findTestObject('02-Dashboard/37-Cuentas/lnkConsulta de Cuentas por Firmante'), 5)
//---------------------------------------------------------------------------------------------------------------------
