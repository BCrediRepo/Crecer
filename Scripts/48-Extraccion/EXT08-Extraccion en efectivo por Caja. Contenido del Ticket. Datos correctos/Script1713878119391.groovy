...
assert ticket.contains('FILIAL :074') == true 
assert ticket.contains('DOMICILIO :')==true
assert ticket.contains( 'Av. J. Urquiza 4724 (B1678AEP) Caseros')==true
assert ticket.contains('Nro. De Cuenta: 119 - 0118359')==true
assert ticket.contains('Denominacion: ENRICO EDIE A OR OTRO')==true
assert ticket.contains('Importe: $ **********************10,00.-')==true
assert ticket.contains('Son: PESOS DIEZ CON 00/100')==true
