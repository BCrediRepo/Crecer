...
WebUI.waitForElementVisible(findTestObject('Object Repository/02-Dashboard/30-Ajustes Monetarios/lnkNotadeCreditoporAjustes'), 6)
WebUI.click(findTestObject('Object Repository/02-Dashboard/30-Ajustes Monetarios/lnkNotadeCreditoporAjustes'))
