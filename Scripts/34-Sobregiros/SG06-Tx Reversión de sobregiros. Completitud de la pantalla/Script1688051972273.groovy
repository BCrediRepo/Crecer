...
WebUI.waitForElementVisible(findTestObject('Object Repository/35-Sobregiros/Overdraft reverses/labelCuenta'), 6)

WebUI.verifyElementVisible(findTestObject('Object Repository/35-Sobregiros/Overdraft reverses/labelCuenta'))

def element = WebUI.getText(findTestObject('Object Repository/35-Sobregiros/Overdraft reverses/labelCuenta'))
