...
WebUI.setText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/DetalleOpSinEfectivoUSUARIO/txtMonedaValue1'),'ARS')
...
WebUI.setText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/DetalleOpSinEfectivoUSUARIO/txtUsuarioValue2'),'B.0089')
...
//Espera y verifica si se visualiza la primera columna del registro
WebUI.waitForElementVisible(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/DetalleOpSinEfectivoUSUARIO/Detalle Transacciones No Efectivo/Page_Account Charge Request/lblRequestTypeJefe'),6)
def element2 = WebUI.getText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/DetalleOpSinEfectivoUSUARIO/Detalle Transacciones No Efectivo/Page_Account Charge Request/lblRequestTypeJefe'))
