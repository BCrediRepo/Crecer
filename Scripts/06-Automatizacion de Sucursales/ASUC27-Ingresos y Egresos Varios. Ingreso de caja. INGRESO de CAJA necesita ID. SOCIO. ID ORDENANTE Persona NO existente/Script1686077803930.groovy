...
WebUI.setText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/IngresosDeCaja/txtOrdenante'),'0303456')
...
//Espera y recibe mensaje de que el id persona es un dato inexistente
WebUI.waitForElementVisible(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/IngresosDeCaja/lblTituloDATOINGRESADOINEXISTENTE'), 6)
WebUI.verifyElementVisible(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/IngresosDeCaja/lblTituloDATOINGRESADOINEXISTENTE'))
def element = WebUI.getText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/IngresosDeCaja/lblTituloDATOINGRESADOINEXISTENTE'))
assert element.contains('DATO INGRESADO INEXISTENTE')
