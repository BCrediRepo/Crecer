...
//Seleccionar "Detalle de Operaciones Sin Efvo (Usuario)"
WebUI.click(findTestObject('Object Repository/07-Automatizacion de Sucursales/Temenos T24/ConsultasVarias/Consultas de Atencion a Usuarios/Consultas de Operatoria en Linea de Cajas/Consultas de Cierre Operatoria/lnkDetalleOpSinEfvo(Usuario)'))

//Cambiar ventana "Totales Usuario x Cod Oper."
...
//Setear Usuario
WebUI.setText(findTestObject('Object Repository/07-Automatizacion de Sucursales/Totales Usuario x Cod Oper/txtUsuario'), 'B.2055')
