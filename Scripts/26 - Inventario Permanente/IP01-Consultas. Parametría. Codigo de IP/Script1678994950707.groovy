...
WebUI.click(findTestObject('27-Inventario Permanente/BCCL.E.IP.CODIGOS/lnkNuevaSeleccion'))

WebUI.click(findTestObject('27-Inventario Permanente/BCCL.E.IP.CODIGOS/lnkEjecutar'))
