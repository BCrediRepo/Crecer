...
//Setear el numero de tx para reversar
WebUI.setText(findTestObject('Object Repository/27-Inventario Permanente/BCCL.IP.PARTIDAS/txtAltadePartidasIP-CuentaSocioTransactionId'),terceraPalabra)

//Boton Herramienta
WebUI.click(findTestObject('Object Repository/27-Inventario Permanente/BCCL.IP.PARTIDAS/btnHerramienta'))

//Verifica operacion reversada
assert element.contains('Txn Completa:')
